...
> **Completeness** implies **Sensivity** because the latter refers to a case where the baseline and the input differ only in one variable. Then Completeness asserts that the difference in the two output values is equal to the attribution to this variable. [Sundararajan et al. (2017)](https://proceedings.mlr.press/v70/sundararajan17a.html)
...
IG satisfy **Input Invariance** meaning that it can explain any differentiable neural network and feature attributions are always identical
