...
class Module(LightningModule):
    def __init__(
        ...
        self.train_pred = MeanMetric()
        self.val_pred = MeanMetric()
    ...
    def training_step(self, batch: Any, batch_idx: int):
        ...
        self.train_pred(logits)
        self.train_auc(logits, targets)
        self.log("train/loss", self.train_loss, on_step=True, on_epoch=True, prog_bar=True)
        self.log("train/pred", self.train_pred, on_step=True, on_epoch=True, prog_bar=True)
    ...
    def validation_step(self, batch: Any, batch_idx: int):
        ...
        self.val_loss(loss)
        self.val_pred(logits)
        self.val_auc(logits, targets)
        self.log("val/loss", self.val_loss, on_step=True, on_epoch=True, prog_bar=True)
        self.log("val/pred", self.val_pred, on_step=True, on_epoch=True, prog_bar=True)
